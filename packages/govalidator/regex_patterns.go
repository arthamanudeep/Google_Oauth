...
const (
	...
	Alpha string = "^[a-zA-Z]+$"
	// AlphaNoSpaceAtStart represents regular expression for alpha characters and some special characters
	AlphaNoSpaceAtStart string = "[^-\\s][a-zA-Z0-9-_.\\s]+$"
	// AlphaSpecial represents regular expression for alpha characters and some special characters
	AlphaSpecial string = "^[-_. 0-9a-zA-Z]+$"
	// AlphaWithSpace represents regular expression for alpha characters with space
	AlphaWithSpace string = "^[-a-zA-Z_ ]+$"
...
var (
	...
	regexAlphaNoSpaceAtStart = regexp.MustCompile(AlphaNoSpaceAtStart)
	regexAlphaSpecial        = regexp.MustCompile(AlphaSpecial)
	regexAlphaDash           = regexp.MustCompile(AlphaDash)
	regexAlphaWithSpace      = regexp.MustCompile(AlphaWithSpace)
