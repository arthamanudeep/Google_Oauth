...
// isAlphaSpecial check the input is letters, number with  some Special characters
func isAlphaSpecial(str string) bool {
	return regexAlphaSpecial.MatchString(str)
}

// isAlphaNoSpaceAtStart check the input is letters, number with  some Special characters
func isAlphaNoSpaceAtStart(str string) bool {
	return regexAlphaNoSpaceAtStart.MatchString(str)
}
...
// isAlphaWithSpace check the input is letters and space
func isAlphaWithSpace(str string) bool {
	return regexAlphaWithSpace.MatchString(str)
}
